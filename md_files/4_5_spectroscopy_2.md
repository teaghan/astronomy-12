...
For example, if a spectral line normally observed at 500 nm appears at 502 nm, the light is redshifted, indicating that the star is moving away from us. By applying the Doppler formula:
...
Astronomers can calculate the speed at which the star or galaxy is moving.

For instance, look at the difference between the spectrum of Arcturus (moving ) and the Sun:
...
1. **Elemental Composition**: How do spectral lines help astronomers identify the elements present in a star’s atmosphere? Provide an example of how hydrogen or helium is detected using spectral lines.
...
3. **Exoplanet Detection**: How does the radial velocity method work in detecting exoplanets? Why does a star “wobble” due to an orbiting planet?

4. **Spectral Line Catalogs**: Why are line lists and databases important in practical spectroscopy? Describe how these tools assist in analyzing the spectra of stars and galaxies.
